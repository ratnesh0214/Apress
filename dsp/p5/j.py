...
WarehouseData=WarehouseData._append(WarehouseRawData.tail(nMax))
WarehouseData=WarehouseData._append(WarehouseRawData[WarehouseRawData.postcode=='KA13'])
if nSet==True:
    WarehouseData=WarehouseData._append(WarehouseRawData[WarehouseRawData.postcode=='SW1W'])
